...
public class EncodedPlayLine extends JMenuItem implements ActionListener {
	public void actionPerformed(ActionEvent e)
	{
		...
		gui.initPlayLineDialog();
		int lineNumber = gui.getLineNumber();
		...
		doc.playLineEncoded(lineNumber);
	}
}
